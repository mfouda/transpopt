...
- [ ] Check that you are up-to-date with the master branch of Transpopt. You can update with:
pip install git+git://github.com/gugarosa/transpopt.git --upgrade --no-deps

- [ ] Check that you have read all of our [README](https://github.com/gugarosa/transpopt/blob/master/README.md).
